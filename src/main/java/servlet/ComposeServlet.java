...
public class ComposeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("</form>");
        out.println("<button onClick=\"fetch(`http://localhost:8080/EmailerSystem/draft?email=${document.getElementById('email').value}&message=${document.getElementById('message').value}`,{method: 'POST'})\">save as draft</button>");
